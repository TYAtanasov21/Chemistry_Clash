...
void Settings::LoadScene() {
	...
	UIManager->AddCheckButton({ {(SCREEN_WIDTH - 500) / 2,  200, 500, 100}, "FULLSCREEN", 50, GRAY, WHITE, BLACK, []() {}});

	UIManager->AddButton({ {(SCREEN_WIDTH - 300) / 2, 550, 300, 100}, "BACK", 50, GRAY, BLACK, []() {
